...
Forward=dir([strcat('D:\Github\GTA5-driverless-car\Training_images'...
    , iteration_number, '\Forward') '/*.jpg']);
Forward_size=size(Forward,1);

%Number of images in Left file
Left=dir([strcat('D:\Github\GTA5-driverless-car\Training_images'...
    , iteration_number, '\Left') '/*.jpg']);
Left_size=size(Left,1);

%Number of images in Right file
Right=dir([strcat('D:\Github\GTA5-driverless-car\Training_images'...
...
for i=1:Forward_size
    img_location = strcat('D:\Github\GTA5-driverless-car\Training_images'...
        , iteration_number, '\Forward\image_', num2str(i), '.jpg');
    copyfile(img_location, strcat('D:\Github\GTA5-driverless-car\Training_images'...
...
elseif min_images_category == 2
    ...
    for i=min_images_number:Forward_size
        delete(strcat('D:\Github\GTA5-driverless-car\Training_images'...
